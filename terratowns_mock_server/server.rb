...
# we will mock  a state or db for this dev server
# by setting a global var. You would never use a global variable in production server.
$home = {}
...
class Home
  ...
  # make sure it an incremental version in the controller.
